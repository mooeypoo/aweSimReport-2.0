...
#	This template ("Clouds") is based on Clouds Email Template by CampaignMonitor.com
							                                ...
							                                <tbody>
							                                    <tr>
							                                        <td valign="baseline" style="vertical-align:baseline; text-align: left;">
																		<h1 style="margin:0; padding:0; font-family: Gill Sans, Trebuchet MS, Helvetica, Arial, sans-serif; font-size: 34px; color:#ffffff; font-weight: normal; letter-spacing:2px;">%%reporttitle%%</h1>
							                                        </td>
							                                    </tr>
							                                    <tr>
							                                        <td colspan="2" valign="top" style="padding-top: 10px; padding-bottom: 15px;">
